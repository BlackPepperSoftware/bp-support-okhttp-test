...
public class HtmlMockWebServerRuleTest {

	private HtmlMockWebServerRule rule = new HtmlMockWebServerRule(8081) {
		// concrete class
	};
	
	@Rule
	public HtmlMockWebServerRule getRule() {
		return rule;
	}
	...
	public void newResponseWithRootReturnsIndex() throws IOException {
		...
		assertThat(toString(actual.getBody()),
			is(fileToString("src/test/resources/uk/co/blackpepper/support/okhttp/test/index.html")));
	}
	...
	public void newResponseWithRootSetsContentType() {
		...
		assertThat(actual.getHeaders(), hasItem("Content-Type: text/html; charset=utf-8"));
	}
	...
	public void newResponseWithPathReturnsFile() throws IOException {
		...
		assertThat(toString(actual.getBody()),
			is(fileToString("src/test/resources/uk/co/blackpepper/support/okhttp/test/x.html")));
	}
	...
	@Test
	public void newResponseWithFaviconReturnsNotFound() {
		MockResponse actual = rule.newResponse(get("/favicon.ico"));
